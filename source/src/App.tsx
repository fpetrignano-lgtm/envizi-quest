...
export default function Home(){
  ...
  const ALL_SCREENS:Screen[]=["cover","welcome","onboarding","intro","approach","questIntro","approachIntro","approachSteps","approachData","approachDecisions","approachRoadmap","approachTrust","approachReport","separatorNext","approachStepsCopy","companySetup","company","priorities","approachDataCopy","priorityData","priorityMatrix","chapterOneSummary","esgStrategist","introCopy","missions","briefing","introCopy2","asis","missionIntro","compare","decision","tobe","trust","milestone","dataFoundation","dfConclusion","dfSummary","reportingFoundation","reportingConclusion","energyFoundation","energyConclusion","supplyFoundation","supplyConclusion","planningFoundation","planningConclusion","frameworkFoundation","frameworkConclusion","success","negative","summary","nextStep","thankYou","roadmapPreview","bridge","esgStrategist"];
